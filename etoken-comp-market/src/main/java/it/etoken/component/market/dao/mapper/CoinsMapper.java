...
public interface CoinsMapper {
	 ...
	 * @mbg.generated  Wed Sep 12 16:51:47 CST 2018
	 */
	@Insert({ "insert into coins (id, name, ", "createdate, modifydate, ", "site, intr, img, ", "tag, total, marke, ",
			"code, symble, contract_account, ", "is_support_market, precision_number, ",
			"issue_date, crowdfunding_price, ", "white_paper_url, block_query_url, ",
			"recommend_level, project_creative, ", "investment_value, crowdfunding_date)",
	 ...
	 * @mbg.generated  Wed Sep 12 16:51:47 CST 2018
	 */
	@Select({ "select", "id, name, createdate, modifydate, site, intr, img, tag, total, marke, code, ",
			...
			"crowdfunding_date", "from coins", "where id = #{id,jdbcType=BIGINT}" })
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.BIGINT, id = true),
			@Result(column = "name", property = "name", jdbcType = JdbcType.VARCHAR),
			@Result(column = "createdate", property = "createdate", jdbcType = JdbcType.TIMESTAMP),
			@Result(column = "modifydate", property = "modifydate", jdbcType = JdbcType.TIMESTAMP),
	...
	@Update({ "update coins", "set name = #{name,jdbcType=VARCHAR},", "createdate = #{createdate,jdbcType=TIMESTAMP},",
			...
			"intr = #{intr,jdbcType=VARCHAR},", "img = #{img,jdbcType=VARCHAR},", "tag = #{tag,jdbcType=VARCHAR},",
			"total = #{total,jdbcType=BIGINT},", "marke = #{marke,jdbcType=BIGINT},",
			"code = #{code,jdbcType=VARCHAR},", "symble = #{symble,jdbcType=VARCHAR},",
			...
			"crowdfunding_date = #{crowdfundingDate,jdbcType=VARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
