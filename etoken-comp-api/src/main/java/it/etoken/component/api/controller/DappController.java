...
public class DappController extends BaseController{
	...
	public Object findAll(@RequestParam Map<String, String> requestMap,HttpServletRequest request) {
		try {
			int page=1;
			int pageSize=10;
			...
			MLResultList<DappInfo> result=dappInfoFacadeAPI.findAll(page, pageSize);
			if(result.isSuccess()) {
