...
import it.etoken.base.model.user.entity.SysconfExample.Criteria;
import it.etoken.base.model.user.entity.SysconfExample.Criterion;
import it.etoken.base.model.user.entity.SysconfExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SysconfSqlProvider {
	 ...
	 */
	public String countByExample(SysconfExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("sysconf");
	 ...
	 * @mbg.generated  Thu Oct 18 19:43:29 CST 2018
	 */
	public String deleteByExample(SysconfExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("sysconf");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Thu Oct 18 19:43:29 CST 2018
	 */
	public String insertSelective(Sysconf record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("sysconf");
	 ...
	 * @mbg.generated  Thu Oct 18 19:43:29 CST 2018
	 */
	public String selectByExample(SysconfExample example) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		Sysconf record = (Sysconf) parameter.get("record");
		SysconfExample example = (SysconfExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("sysconf");
		if (record.getId() != null) {
	 ...
	 * @mbg.generated  Thu Oct 18 19:43:29 CST 2018
	 */
	public String updateByPrimaryKeySelective(Sysconf record) {
		SQL sql = new SQL();
		sql.UPDATE("sysconf");
		if (record.getName() != null) {
	 ...
	 * @mbg.generated  Thu Oct 18 19:43:29 CST 2018
	 */
	protected void applyWhere(SQL sql, SysconfExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
