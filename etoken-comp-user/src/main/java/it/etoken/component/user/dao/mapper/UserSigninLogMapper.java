...
public interface UserSigninLogMapper {
     ...
     *
     * @mbg.generated Thu Sep 06 11:20:17 CST 2018
     */
     ...
     */
    @Insert({
        "insert into user_signin_log (id, uid, nickname, ",
        "signdate, createdate)",
        "values (#{id,jdbcType=BIGINT}, #{uid,jdbcType=BIGINT}, #{nickname,jdbcType=VARCHAR}, ",
        "#{signdate,jdbcType=VARCHAR}, #{createdate,jdbcType=TIMESTAMP})"
    })
    ...
    @Results({
        ...
        @Result(column="signdate", property="signdate", jdbcType=JdbcType.VARCHAR),
