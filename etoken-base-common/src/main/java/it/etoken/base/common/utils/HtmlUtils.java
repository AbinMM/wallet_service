...
public class HtmlUtils {
	...
	//添加资讯的html模板
	public static String gemHtmlforAlertsUpdate(String content, String title,String eosprice,String savePath,String filePath,String template) throws Exception {
		File f = new File(savePath + filePath);
		if (!f.getParentFile().exists()) {
			f.getParentFile().mkdirs();
		}
